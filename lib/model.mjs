...
// declared to none in particular and to every type at once: it stands on the declared-to side of
// each of them, in `describeRelations` and in `describeSchema`'s `referencedBy` alike.
