...
export function createHttpServer(snapshot, { allowedHosts = null, pageCss = null, pageIcon = null } = {}) {
  ...
  return http.createServer(async (req, res) => {
    ...
    if (pathname === "/" && (req.method === "GET" || req.method === "HEAD")) {
      ...
      const body = renderPage(snapshot, { origin: `${proto}://${host}`, css: pageCss, icon: pageIcon });
