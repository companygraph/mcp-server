...
// the local case. The SDK buffers a POST body whole and has no size option of its own, so a
...
export function createHttpServer(snapshot, { allowedHosts = null, pageCss = null, pageIcon = null, pageBrand = null } = {}) {
  ...
  return http.createServer(async (req, res) => {
    ...
    if (pathname === "/" && (req.method === "GET" || req.method === "HEAD")) {
      ...
      const body = renderPage(snapshot, { origin: `${proto}://${host}`, css: pageCss, icon: pageIcon, brand: pageBrand });
