...
export const TOOLS = [
  ...
  { name: "describe_relations",
    description: "What the schemas declare between types: references with form and cardinality, ownership, enums, joins, list kinds. Use for a diagram or an audit; for one type's full schema use describe_schema. Optional `type`, `direction` (declares, declared-to, both; needs `type`) and `via` narrow it. Returns those lists, with `forms` and `reading` explaining every term. Not paged.",
